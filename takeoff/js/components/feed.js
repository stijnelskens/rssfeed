...
$.each(dataUrls, function (i, u) {
    ...
    $.ajax({
        ...
        for (const i in response.items) {
            ...
            if (
                feedEntry.categories.includes('Fashion') ||
                feedEntry.categories.includes('Sneakers') ||
                feedEntry.categories.includes('Style') ||
                feedEntry.categories.includes('Mode') ||
                feedEntry.categories.includes('Supreme') ||
                feedEntry.categories.includes('Footwear') ||
                feedEntry.categories.includes('Yeezy') ||
                feedEntry.categories.includes('Nike')
                ) {
                ...
                const ampFix = feedEntry.title.replace(/&amp;/g, '&');
                feedEntryLinkElement.innerText = ampFix;
